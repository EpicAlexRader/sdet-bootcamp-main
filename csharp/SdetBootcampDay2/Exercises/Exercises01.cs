...
namespace SdetBootcampDay2.Exercises
{
    ...
    //         orderHandler.Pay(OrderItem.FIFA_24, 1);
    ...
    //             orderHandler.Pay(OrderItem.Fortnite, 101);
    ...
    //         var orderHandler = new OrderHandler(stock, new PaymentProcessor(PaymentProcessorType.Stripe));
    //         /*
    //         // var assertResult = Assert.Throws<ArgumentException>(() =>
    //         // {
    //         //     account.Withdraw(100);
    //         // });

    //         // Assert.That(assertResult!.Message, Is.EqualTo("You cannot overdraw on a savings account"));*/
    //         var assertResult = Assert.Throws<ArgumentException>(() =>
    //         {
    //             orderHandler.Order(OrderItem.DayOfTheTentacle, 1);
    //         });

    //         Assert.That(assertResult!.Message, Is.EqualTo($"Insufficient stock for item {OrderItem.DayOfTheTentacle}"));
    //     }
    //     [Test]
    //     public void PaypalOrder()
    //     {
    //         Dictionary<OrderItem, int> stock = new Dictionary<OrderItem, int>
    //         {
    //             { OrderItem.DayOfTheTentacle, 25 }
    //         };

    //         var orderHandler = new OrderHandler(stock, new PaymentProcessor(PaymentProcessorType.Paypal));
    //         orderHandler.Order(OrderItem.DayOfTheTentacle, 6);
    //     }
    }
}
